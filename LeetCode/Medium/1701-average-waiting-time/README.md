<h2><a href="https://leetcode.com/problems/average-waiting-time/">1701. Average Waiting Time</a></h2><h3>Medium</h3><hr><div bis_skin_checked="1"><p>There is a restaurant with a single chef. You are given an array <code>customers</code>, where <code>customers[i] = [arrival<sub>i</sub>, time<sub>i</sub>]:</code></p>
